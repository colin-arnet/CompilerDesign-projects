...
let feat = 
  let program_result = (oat_file_test "hw5programs/newfeature.oat" "") in
  let _ = (print_string program_result) in
  assert_eq program_result "26"
